...
public class CritialSectionServiceNode {
    ...
    private long counterValueWhenRequest;
	...
	public CritialSectionServiceNode(String id, LamportCounter counter, CriticalSectionState state) {
		...
		this.state = state;
		this.counterValueWhenRequest = 0;
	...
	public long getCounterValueWhenRequest() {
		return counterValueWhenRequest;
	}


	public void setCounterValueWhenRequest() {
		this.counterValueWhenRequest = counter.getCounter();
	}
